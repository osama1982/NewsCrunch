...
public class NewsCrunchActivity extends AppCompatActivity
        implements LoaderCallbacks<List<NewsItem>> {

    //Store class name for log messages
    private static final String LOG_TAG = NewsCrunchActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_crunch);

        ncProgressBar = (ProgressBar) findViewById(R.id.loading_spinner);
        ...
        ncStatusTextView = (TextView) findViewById(R.id.status_textview);
